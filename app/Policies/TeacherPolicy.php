...
class TeacherPolicy
{
    ...
    {
        if($user->can('delete_any_teacher'))
            return true;
        else
            return false;
    ...
    {
        if($user->can('force_delete_teacher'))
            return true;
        else
            return false;
    ...
    {
        if($user->can('force_delete_any_teacher'))
            return true;
        else
            return false;
    ...
    public function imports(User $user): bool
    {
        return $user->can('imports_teacher');
    }
}
